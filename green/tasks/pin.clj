...
(defn blue-pinned-meta [sha]
  (str "# dependencies = [\"package-redis-blue\", \"blue\", \"colors-compute-blue @ git+https://github.com/getcolors/colors-compute.git@73341a51a20a8e052e5432461fb03a7ab30ff2cd#subdirectory=blue\"]\n"
       "#\n"
       "# [tool.uv.sources]\n"
