...
export RCLONE_CONFIG_BACKUP_ENDPOINT="https://s3.us-east-1.amazonaws.com" RCLONE_CONFIG_BACKUP_REGION="us-east-1"
...
PROFILE="redis-aws-fixture"
BACKUP_BUCKET="redis-aws-fixture-backup"
SET_PREFIX="redis-aws-fixture/redis"
RETENTION_DAYS=7
MAX_AGE_HOURS=8
