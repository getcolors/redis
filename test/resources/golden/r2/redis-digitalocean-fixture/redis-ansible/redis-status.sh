...
echo "  ssh -L 6379:127.0.0.1:6379 redis-digitalocean-fixture"
echo "  REDISCLI_AUTH=\$(ssh redis-digitalocean-fixture sudo -n cat /etc/redis/secrets/password) redis-cli -p 6379"
