...
export RCLONE_CONFIG_BACKUP_ENDPOINT="<{ redis-backup-r2-endpoint }>" RCLONE_CONFIG_BACKUP_REGION="<{ redis-backup-r2-region }>"
...
PROFILE="<{ profile }>"
BACKUP_BUCKET="<{ redis-backup-r2-bucket }>"
SET_PREFIX="<{ redis-backup-set-prefix }>"
RETENTION_DAYS=<{ redis-backup-retention-days }>
MAX_AGE_HOURS=<{ redis-backup-max-age-hours }>
